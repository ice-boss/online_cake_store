...
<a href="?site=product_details" class="position-absolute">
<span class="badge badge-danger m-3">10%</span>
</a>
<div class="d-flex  align-items-center p-3">
<a href="?site=product_details"><img src="img/cart/g1.png" class="img-fluid"></a>
<a href="?site=product_details" class="ml-3 text-dark text-decoration-none w-100">
...
<div class="cart-items bg-white position-relative border-bottom">
<div class="d-flex  align-items-center p-3">
<a href="?site=product_details"><img src="img/cart/g2.png" class="img-fluid"></a>
<a href="?site=product_details" class="ml-3 text-dark text-decoration-none w-100">
...
<div class="cart-items bg-white position-relative border-bottom">
<div class="d-flex  align-items-center p-3">
<a href="?site=product_details"><img src="img/cart/g3.png" class="img-fluid"></a>
<a href="?site=product_details" class="ml-3 text-dark text-decoration-none w-100">
...
<div class="p-3 mt-5">
<a href="?site=order_address" class="text-decoration-none">
...
<a href="?site=cart" class="text-muted col small font-weight-bold text-decoration-none p-2 selected">
