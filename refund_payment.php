...
<a class="font-weight-bold text-success text-decoration-none" href="?site=help_support">
<i class="icofont-rounded-left back-page" onclick="back()"></i></a>
<h6 class="font-weight-bold m-0 ml-3">Help & Ticket</h6>
