...
<a class="font-weight-bold text-success text-decoration-none" href="?site=home">
...
<input type="text" class="shadow-none border-0 form-control pl-0" placeholder="Search for Products.." aria-label="" aria-describedby="basic-addon1" value="Apple">
</div>
</div>
</div>
</div>
<a href="?site=listing" class="text-dark">
...
<a href="?site=listing" class="text-dark">
<div class="d-flex align-items-center border-bottom p-3">
<img src="img/search/s2.jpg" class="img-fluid rounded shadow-sm mr-3">
<span class="font-weight-bold">
Japan Red Apple
...
<a href="?site=listing" class="text-dark">
<div class="d-flex align-items-center border-bottom p-3">
<img src="img/search/s3.jpg" class="img-fluid rounded shadow-sm mr-3">
<span class="font-weight-bold">
Fresh Orange
...
<a href="?site=listing" class="text-dark">
<div class="d-flex align-items-center border-bottom p-3">
<img src="img/search/s4.jpg" class="img-fluid rounded shadow-sm mr-3">
<span class="font-weight-bold">
Fresh Tomato
